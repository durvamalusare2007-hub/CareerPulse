...
SKILL_TAXONOMY: Dict[str, Dict[str, List[str]]] = {
    "Programming Languages": {
        ...
        "Rust": ["rust", "rustlang", "rust programming"],
        "Ruby": ["ruby", "ruby on rails", "ror"],
        "PHP": ["php", "php7", "php8"],
        "SQL": ["sql", "t-sql", "pl/sql", "ansi sql"],
        "HTML/CSS": ["html", "html5", "css", "css3", "sass", "scss", "less"],
        "Bash/Shell": ["bash", "shell scripting", "powershell", "zsh", "shell script"],
        "Kotlin": ["kotlin"],
        "Swift": ["swift", "swiftui"],
        "R": ["r programming", "r-lang", "r language", "r stats"],
        "Scala": ["scala"],
    },
    "Frameworks & Libraries": {
        "React": ["react", "react.js", "reactjs", "react-dom", "react native"],
        "Node.js": ["node.js", "nodejs", "express", "express.js", "nest.js", "nestjs"],
    ...
    "Cloud & DevOps": {
        ...
        "CI/CD": ["ci/cd", "continuous integration", "continuous deployment", "github actions", "gitlab ci", "jenkins", "circleci", "argo cd"],
        "Terraform": ["terraform", "infrastructure as code"],
        "Linux": ["linux", "ubuntu", "debian", "centos", "redhat", "unix"],
        "Nginx": ["nginx"],
        "Ansible": ["ansible"],
        "Prometheus": ["prometheus", "grafana", "observability", "datadog", "elk stack", "splunk"],
    },
    "Databases & Storage": {
    ...
    "AI, ML & Data Science": {
        "Machine Learning": ["machine learning", "supervised learning", "unsupervised learning", "model training", "predictive modeling"],
        "Deep Learning": ["deep learning", "neural networks", "cnn", "rnn", "transformers", "lstm"],
        "Natural Language Processing (NLP)": ["natural language processing", "spacy", "nltk", "hugging face", "large language models", "bert", "gpt", "rag", "embeddings", "langchain"],
        ...
        "Data Engineering": ["data engineering", "etl", "elt", "data pipeline", "airflow", "apache spark", "dbt"],
...
# Flat lookup map of aliases to canonical skill names and categories
...
def normalize_text(text: str) -> str:
    """Clean and normalize text while preserving tech characters."""
    text = text.lower()
...
def extract_skills_from_text(text: str) -> Dict[str, Any]:
    """
    Extracts standardized skills present in a text string.
    Only returns skills that are genuinely found in the text.
    """
    if not text or not text.strip():
        return {"skills": [], "categorized": {}, "skill_details": [], "total_count": 0}
